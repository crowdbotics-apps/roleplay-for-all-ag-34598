...
## Project Structure
    ...
    ├── roleplay_for_all_ag_34598  # Django project configurations
...
1. Clone this repo and `cd roleplay_for_all_ag_34598`
...
2. Clone this repo and `cd roleplay_for_all_ag_34598`
